...
(() => {
    ...
    async function unlock() {
        ...
        try {
            ...
            // iOSの画面復帰ではsuspended以外にinterruptedになる場合がある。
    ...
    // タッチ開始だけでなく、タップ完了時にもユーザー操作の中で再開を試す。
    // キャプチャで受け、子要素のstopPropagationの影響を受けない。
    ...
    document.getElementById('audio-resume').addEventListener('click', async () => {
        await unlock();
        effect('confirm');
    });
